    ...
    <div className="px-6 -mt-6">
      <div className="bg-white rounded-[32px] p-2 shadow-xl shadow-blue-900/5 border border-gray-100 grid grid-cols-3 gap-1">
        ...
        >
          ...
          <span className="text-[11px] font-bold text-gray-600">{t('deposit')}</span>
        </button>
        <button 
        ...
        >
          ...
          <span className="text-[11px] font-bold text-gray-600">{t('bank')}</span>
        </button>
        <button 
        ...
        >
          ...
          <span className="text-[11px] font-bold text-gray-600">{t('buyVip')}</span>
        </button>
      </div>
    </div>
  );
