    ...
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="relative h-[500px] bg-gradient-to-br from-[#1877F2] to-[#4F46E5] overflow-hidden flex items-center justify-center text-white text-center px-6">
        ...
        >
          ...
          <h1 className="text-4xl md:text-8xl font-black tracking-tighter mb-8 leading-[0.9]">
            TEENTASK <br/>
            <span className="text-white/60">PROJECT</span>
          </h1>
          <p className="text-lg md:text-2xl font-bold opacity-90 leading-relaxed max-w-2xl mx-auto">
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 -mt-20 relative z-20">
          ...
          <div className="grid grid-cols-1 gap-8 sm:gap-12">
            {roles.map((r, i) => (
              <motion.div 
                ...
                viewport={{ once: true }}
                className="bg-white rounded-[32px] sm:rounded-[48px] border border-gray-100 shadow-xl p-6 sm:p-8 md:p-12"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
            {pillars.map((p, i) => (
              <motion.div 
                key={i}
                whileHover={{ y: -10 }}
                className="bg-white p-6 sm:p-10 rounded-[32px] sm:rounded-[48px] border border-gray-100 shadow-xl shadow-gray-200/50 relative overflow-hidden group"
              >
        ...
        <section className="space-y-20 mb-32">
          <div className="bg-gray-50 rounded-[40px] sm:rounded-[64px] p-6 sm:p-12 md:p-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16">
              <div className="space-y-10">
                <h3 className="text-2xl sm:text-3xl font-black text-gray-900">Mô hình trải nghiệm <br/>độc đáo</h3>
                <div className="space-y-6 sm:space-y-8">
                  {[
                    ...
                    <div key={i} className="flex gap-4 sm:gap-6 group">
                      <div className="w-12 h-12 sm:w-14 h-14 bg-white rounded-2xl shadow-sm flex items-center justify-center text-blue-600 shrink-0 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
                        <item.icon className="w-5 h-5 sm:w-6 sm:h-6" />
                      </div>
                      <div className="space-y-1">
                        <h4 className="font-black text-gray-900 text-sm sm:text-base">{item.title}</h4>
              ...
              <div className="bg-white rounded-[32px] sm:rounded-[48px] p-6 sm:p-10 shadow-xl shadow-gray-200/50 border border-gray-100">
                <h3 className="text-xl sm:text-2xl font-black text-gray-900 mb-8 flex items-center gap-3">
        ...
        <section className="space-y-16 mb-32">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {[
              ...
              <div key={i} className="relative p-6 sm:p-8 bg-white border border-gray-100 rounded-[32px] sm:rounded-[40px] shadow-sm hover:shadow-xl transition-all group">
        ...
        {/* Survey CTA */}
        <section className="bg-gradient-to-br from-gray-900 to-blue-900 rounded-[40px] sm:rounded-[64px] p-8 sm:p-12 md:p-24 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-8 sm:space-y-10">
            ...
            <button 
              ...
              className="group inline-flex items-center gap-3 sm:gap-4 px-8 sm:px-12 py-4 sm:py-6 bg-white text-gray-900 rounded-full font-black text-lg sm:text-xl shadow-2xl hover:bg-blue-50 hover:scale-105 transition-all active:scale-95"
            >
